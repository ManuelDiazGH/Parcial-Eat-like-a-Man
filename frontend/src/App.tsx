...
function Navbar() {
  ...
  return (
    <nav style={{ backgroundColor: '#0a0a0a', borderBottom: '1px solid #1a1a1a' }}
      className="fixed top-0 left-0 right-0 z-50 px-8 py-4 flex items-center justify-between">
      <Link to="/" className="flex items-center gap-2">
        <span style={{ color: '#cc1a1a', fontSize: '1.4rem' }}>
        <img src="https://static.vecteezy.com/system/resources/previews/003/011/417/non_2x/bull-head-logo-icon-template-design-free-vector.jpg"
         alt="logo"
        ...
        {links.map(l => (
          <Link key={l.to} to={l.to}
            style={{
              ...
              color: location.pathname.startsWith(l.to) ? '#cc1a1a' : '#ede8df',
              textDecoration: 'none',
            }}>
            {l.label}
          </Link>
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              'linear-gradient(to right, rgba(10,10,10,0.88) 50%, rgba(10,10,10,0.55) 100%)',
            zIndex: 1,
          }}
        />
        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
          ...
          >
            ...
            COMO
            <br />
            <span style={{ color: '#cc1a1a' }}>UN HOMBRE</span>
          </h1>
    ...
    {/* Marquesina */}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', borderTop: '1px solid #1a1a1a' }}>
        {[
          ...
          <div key={i} style={{
            padding: '3rem 2rem', borderRight: i < 3 ? '1px solid #1a1a1a' : 'none',
            textAlign: 'center'
          }}>
